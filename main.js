...
define('packages/demo/app', ['exports', 'nume', 'calcule/adunare', 'calcule/scadere'], function (exports, _nume, _calculeAdunare, _calculeScadere) {

	var plus = (0, _calculeAdunare['default'])(1, 2);
	var minus = (0, _calculeScadere['default'])(9, 3);

	var rezultate = {
		framework: _nume['default'],
		plus: plus,
		minus: minus
	};

	exports['default'] = rezultate;
});

define("packages/demo/calcule/adunare", ["exports"], function (exports) {
...
define("packages/demo/calcule/scadere", ["exports"], function (exports) {
...
define('packages/demo/nume', ['exports'], function (exports) {
  var nume = 'oktopus';

  exports['default'] = nume;
});

define('packages/main/main', ['exports'], function (exports) {
  var exportedToGlobalNamespace = {};

  exportedToGlobalNamespace.version = '0.0.1';

  exports['default'] = exportedToGlobalNamespace;
});

define('packages/utils/main', ['exports'], function (exports) {
